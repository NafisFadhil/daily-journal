...
if (isset($_POST['simpan'])) {
	...
	if ($nama_gambar != '') {
		...
		if ($cek_upload['status']) {
			...
			echo "<script>
                ...
                document.location='admin.php?page=galeri';
            </script>";
			die;
		}
	}
	...
	if (isset($_POST['id'])) {
		...
		$stmt = $conn->prepare("UPDATE galeri 
                                SET 
                                deskripsi =?,
                                gambar = ?,
                                tanggal = ?,
		...
		$stmt = $conn->prepare("INSERT INTO galeri (deskripsi,gambar,tanggal,username)
                                VALUES (?,?,?,?)");
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h1 class="modal-title fs-5" id="modalTambahLabel">Tambah Galeri</h1>
					...
					<form method="post" action="" enctype="multipart/form-data">
						<div class="modal-body">
							...
							<div class="mb-3">
								...
								<textarea class="form-control" placeholder="Tuliskan Deskripsi Galeri" name="deskripsi" required></textarea>
							</div>
						</div>
